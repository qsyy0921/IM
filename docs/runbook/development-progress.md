...
| `receipt-service` | 已落地、已接主链路 | receipt projection / outbox / audit / repair、`ListReceiptStates` repository 级批量查询、会话列表 unread / pinned / muted 过滤、first-stage `/metrics` 和 OTel server span | `service-briefs/receipt-service.md` |
