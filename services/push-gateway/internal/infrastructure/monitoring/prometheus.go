...
func writeRedisRoutePrometheusSamples(builder *strings.Builder, role string, snapshot *redisroute.Metrics) {
	...
	writePrometheusSample(builder, "nexusim_push_gateway_redis_route_events_total", labels("conversation_route_cache_hit"), snapshot.RedisRouteConversationRouteCacheHitCount)
	writePrometheusSample(builder, "nexusim_push_gateway_redis_route_events_total", labels("conversation_route_cache_miss"), snapshot.RedisRouteConversationRouteCacheMissCount)
	writePrometheusSample(builder, "nexusim_push_gateway_redis_route_events_total", labels("conversation_route_cache_invalidated"), snapshot.RedisRouteConversationRouteCacheInvalidatedCount)
