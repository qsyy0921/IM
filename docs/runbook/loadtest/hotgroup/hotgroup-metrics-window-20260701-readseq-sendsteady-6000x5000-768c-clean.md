...
- run_name: hotgroup-readseq-sendsteady-6000x5000-768c-clean-4af8fa1a-20260701-1715
- commit: 4af8fa1
- git_dirty: False
...
- window_start_utc: 2026-07-01T09:01:58.5784056Z
- window_end_utc: 2026-07-01T09:15:46.2341465Z
- step_seconds: 30
...
| message_send_p95_ms | True | 1 | 28 | 250.994 | 325.341 | 325.341 | max(nexusim_message_latency_p95_milliseconds{operation="send_message"}) |
| message_send_p99_ms | True | 1 | 28 | 351.188 | 404.214 | 373.534 | max(nexusim_message_latency_p99_milliseconds{operation="send_message"}) |
| message_send_p95_recent_ms | True | 1 | 28 | 236.041 | 329.987 | 329.987 | max(nexusim_message_latency_p95_milliseconds{operation="send_message_recent"}) |
| message_send_p99_recent_ms | True | 1 | 28 | 248.76 | 348.276 | 348.276 | max(nexusim_message_latency_p99_milliseconds{operation="send_message_recent"}) |
| message_seq_alloc_p99_ms | True | 1 | 28 | 0.024 | 0.024 | 0.024 | max(nexusim_message_latency_p99_milliseconds{operation="conversation_seq_alloc"}) |
| message_seq_alloc_p99_recent_ms | True | 1 | 28 | 0.023 | 0.024 | 0.024 | max(nexusim_message_latency_p99_milliseconds{operation="conversation_seq_alloc_recent"}) |
| message_repository_append_p99_ms | True | 1 | 28 | 124.706 | 243.175 | 124.706 | max(nexusim_message_latency_p99_milliseconds{operation="repository_append"}) |
| message_repository_append_p99_recent_ms | True | 1 | 28 | 41.711 | 63.52 | 49.56 | max(nexusim_message_latency_p99_milliseconds{operation="repository_append_recent"}) |
| message_repository_pool_acquire_p99_ms | True | 1 | 28 | 17.305 | 114.82 | 17.305 | max(nexusim_message_latency_p99_milliseconds{operation="repository_pool_acquire"}) |
| message_repository_pool_acquire_p99_recent_ms | True | 1 | 28 | 0.071 | 0.538 | 0.071 | max(nexusim_message_latency_p99_milliseconds{operation="repository_pool_acquire_recent"}) |
| message_repository_tx_begin_p99_ms | True | 1 | 28 | 7.656 | 7.802 | 7.656 | max(nexusim_message_latency_p99_milliseconds{operation="repository_tx_begin"}) |
| message_repository_tx_begin_p99_recent_ms | True | 1 | 28 | 6.116 | 6.897 | 6.116 | max(nexusim_message_latency_p99_milliseconds{operation="repository_tx_begin_recent"}) |
| message_repository_idempotency_lock_p99_ms | True | 1 | 28 | 8.751 | 11.277 | 8.751 | max(nexusim_message_latency_p99_milliseconds{operation="repository_idempotency_lock"}) |
| message_repository_idempotency_lock_p99_recent_ms | True | 1 | 28 | 6.412 | 6.765 | 6.765 | max(nexusim_message_latency_p99_milliseconds{operation="repository_idempotency_lock_recent"}) |
| message_repository_find_existing_p99_ms | True | 1 | 28 | 13.867 | 19.542 | 13.867 | max(nexusim_message_latency_p99_milliseconds{operation="repository_find_existing"}) |
| message_repository_find_existing_p99_recent_ms | True | 1 | 28 | 7.155 | 7.355 | 7.155 | max(nexusim_message_latency_p99_milliseconds{operation="repository_find_existing_recent"}) |
...
| message_repository_insert_message_p99_ms | True | 1 | 28 | 23.044 | 24.31 | 23.044 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_message"}) |
| message_repository_insert_message_p99_recent_ms | True | 1 | 28 | 16.157 | 20.75 | 17.747 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_message_recent"}) |
| message_repository_insert_timeline_p99_ms | True | 1 | 28 | 25.396 | 30.386 | 25.396 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_timeline"}) |
| message_repository_insert_timeline_p99_recent_ms | True | 1 | 28 | 14.921 | 32.349 | 14.921 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_timeline_recent"}) |
| message_repository_insert_outbox_p99_ms | True | 1 | 28 | 28.676 | 34.604 | 28.676 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_outbox"}) |
| message_repository_insert_outbox_p99_recent_ms | True | 1 | 28 | 16.951 | 26.525 | 17.471 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_outbox_recent"}) |
| message_repository_commit_p99_ms | True | 1 | 28 | 13.819 | 15.453 | 13.819 | max(nexusim_message_latency_p99_milliseconds{operation="repository_commit"}) |
| message_repository_commit_p99_recent_ms | True | 1 | 28 | 10.067 | 11.462 | 11.177 | max(nexusim_message_latency_p99_milliseconds{operation="repository_commit_recent"}) |
...
| delivery_grpc_rps | True | 1 | 28 | 0 | 0.067 | 0 | sum(rate(nexusim_delivery_grpc_method_requests_total[5m])) |
...
| push_redis_route_events_5m | True | 1 | 28 | 964.602 | 10480.156 | 964.602 | sum(increase(nexusim_push_gateway_redis_route_events_total[5m])) |
...
| push_redis_delivery_consumer_conversation_route_cache_hit_5m | True | 1 | 28 | 456.547 | 4809.84 | 456.547 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_hit"}[5m])) |
| push_redis_delivery_consumer_conversation_route_cache_miss_5m | True | 1 | 28 | 51.508 | 706.032 | 51.508 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_miss"}[5m])) |
...
| push_writer_frame_write_success_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="frame_write_success"}[828s])) |
| push_writer_frame_write_error_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="frame_write_error"}[828s])) |
| push_writer_delivery_notify_success_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="delivery_notify_write_success"}[828s])) |
| push_writer_delivery_notify_error_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="delivery_notify_write_error"}[828s])) |
| push_writer_delivery_notify_duration_p95_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_ws_writer_write_duration_milliseconds_bucket{operation="delivery_notify"}[828s])) by (le)) |
| push_writer_delivery_notify_duration_p99_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_ws_writer_write_duration_milliseconds_bucket{operation="delivery_notify"}[828s])) by (le)) |
| push_writer_delivery_notify_queue_p95_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_ws_writer_queue_duration_milliseconds_bucket{operation="delivery_notify"}[828s])) by (le)) |
| push_writer_delivery_notify_queue_p99_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_ws_writer_queue_duration_milliseconds_bucket{operation="delivery_notify"}[828s])) by (le)) |
| push_redis_subscriber_messages_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_message"}[828s])) |
| push_redis_subscriber_enqueued_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_enqueued"}[828s])) |
| push_redis_subscriber_evicted_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_evicted"}[828s])) |
| push_redis_subscriber_errors_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_error"}[828s])) |
| push_redis_registry_conversation_route_cache_hit_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_hit"}[828s])) |
| push_redis_registry_conversation_route_cache_miss_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_miss"}[828s])) |
| push_redis_registry_conversation_route_cache_invalidated_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_invalidated"}[828s])) |
| push_redis_delivery_consumer_remote_matched_sessions_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_matched_sessions"}[828s])) |
| push_redis_delivery_consumer_remote_publish_call_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_call"}[828s])) |
| push_redis_delivery_consumer_remote_publish_error_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_error"}[828s])) |
| push_redis_delivery_consumer_conversation_route_cache_hit_window | True | 1 | 28 | 8925.516 | 13532.029 | 8957.143 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_hit"}[828s])) |
| push_redis_delivery_consumer_conversation_route_cache_miss_window | True | 1 | 28 | 991.593 | 1522.516 | 1189.145 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_miss"}[828s])) |
| push_redis_delivery_consumer_conversation_route_cache_invalidated_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_invalidated"}[828s])) |
| push_redis_delivery_consumer_remote_enqueued_sessions_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_enqueued_sessions"}[828s])) |
| push_redis_subscriber_signal_fanout_queued_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_queued"}[828s])) |
| push_redis_subscriber_signal_fanout_queue_full_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_queue_full"}[828s])) |
| push_redis_subscriber_signal_fanout_worker_errors_window | True | 1 | 28 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_worker_error"}[828s])) |
| push_redis_subscriber_signal_fanout_duration_p95_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_redis_subscriber_fanout_duration_milliseconds_bucket{operation="conversation_signal"}[828s])) by (le)) |
| push_redis_subscriber_signal_fanout_duration_p99_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_redis_subscriber_fanout_duration_milliseconds_bucket{operation="conversation_signal"}[828s])) by (le)) |
| push_redis_subscriber_signal_fanout_queue_wait_p95_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_redis_subscriber_signal_fanout_queue_wait_duration_milliseconds_bucket[828s])) by (le)) |
| push_redis_subscriber_signal_fanout_queue_wait_p99_ms_window | True | 1 | 28 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_redis_subscriber_signal_fanout_queue_wait_duration_milliseconds_bucket[828s])) by (le)) |
