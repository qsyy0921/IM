...
- operator visibility：provider-replay queue、operator queues、compensation review bundle / page、
  approval queue review page / batch decision manifest / runner、`ListWorkflowCompensations` execution result query。
...
## 后续
- 更多 compensation adapter、provider-grade approval platform、callback delivery persisted dashboard、workflow outbox relay。
