...
func TestConversationOperatorReasonFromEnvDefault(t *testing.T) {
	...
	reason, err := conversationOperatorReasonFromEnv("NEXUSIM_CONVERSATION_TEST_REASON", "NEXUSIM_CONVERSATION_TEST_REASON_FILE", "manual reason")
	if err != nil {
...
func TestConversationOperatorReasonRejectsAmbiguousEnvAndFile(t *testing.T) {
	...
	t.Setenv("NEXUSIM_CONVERSATION_TEST_REASON_FILE", reasonPath)
	if _, err := conversationOperatorReasonFromEnv("NEXUSIM_CONVERSATION_TEST_REASON", "NEXUSIM_CONVERSATION_TEST_REASON_FILE", "manual reason"); err == nil {
