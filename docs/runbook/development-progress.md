...
- PostgreSQL quorum observation smoke
...
3. 分布式故障 smoke：补 Kafka 多故障 / ISR 抖动，并为 PostgreSQL 生产级 quorum / split-brain fencing 设计后续方案，明确和本地 `repmgr + pgpool` observation 的差距。
