...
2. ADR candidate package：`docs/research/adr-candidates/` 已起草六个候选 ADR
   ...
   Eval / Replay 与 Runtime / Workflow L1 已接受，Context / EvidencePack L1 自评包已起草，未接受前不提升生产契约。
3. Fixture-only evidence hardening：Eval / Replay、Runtime / Workflow、Context /
   ...
   Runtime / Workflow L1 已被主集成接受；下一步等待 Context / EvidencePack L1 verdict 或 owner / smoke 证据要求。
