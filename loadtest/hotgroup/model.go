...
type summary struct {
	...
	BaselineUserInboxRows        int64          `json:"baseline_user_inbox_rows"`
	BaselineDeliveryTimelineRows int64          `json:"baseline_delivery_timeline_rows"`
	TargetUserInboxRows          int64          `json:"target_user_inbox_rows"`
	TargetDeliveryTimelineRows   int64          `json:"target_delivery_timeline_rows"`
