...
function New-HotGroupMetricQueries {
    ...
    return @(
        [pscustomobject]@{ name = "core_targets_up"; query = 'sum(up{job=~"nexusim-message-service|nexusim-conversation-service|nexusim-policy-service|nexusim-delivery-service|nexusim-push-gateway"})' },
        ...
        [pscustomobject]@{ name = "message_command_build_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_command_build_recent"})' },
        [pscustomobject]@{ name = "message_admission_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_admission_recent"})' },
        [pscustomobject]@{ name = "message_dependency_read_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_dependency_read_recent"})' },
        [pscustomobject]@{ name = "message_conversation_context_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_conversation_context_recent"})' },
        [pscustomobject]@{ name = "message_policy_check_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_policy_check_recent"})' },
        [pscustomobject]@{ name = "message_seq_floor_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_seq_floor_recent"})' },
        [pscustomobject]@{ name = "message_sequencer_allocate_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_sequencer_allocate_recent"})' },
        [pscustomobject]@{ name = "message_repository_append_call_p99_recent_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="send_message_repository_append_call_recent"})' },
        ...
        [pscustomobject]@{ name = "message_outbox_process_ready_active_recent_p99_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="outbox_process_ready_active_recent"})' },
        [pscustomobject]@{ name = "message_outbox_process_ready_active_recent_max_ms"; query = 'max(nexusim_message_latency_max_milliseconds{operation="outbox_process_ready_active_recent"})' },
        [pscustomobject]@{ name = "message_outbox_fetch_ready_p99_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="outbox_fetch_ready"})' },
        [pscustomobject]@{ name = "message_outbox_mark_published_p99_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="outbox_mark_published"})' },
        [pscustomobject]@{ name = "message_outbox_commit_p99_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="outbox_commit"})' },
        [pscustomobject]@{ name = "message_kafka_publish_call_p99_ms"; query = 'max(nexusim_message_latency_p99_milliseconds{operation="kafka_publish_call"})' },
        [pscustomobject]@{ name = "message_kafka_publish_call_max_ms"; query = 'max(nexusim_message_latency_max_milliseconds{operation="kafka_publish_call"})' },
        [pscustomobject]@{ name = "message_outbox_relay_errors_5m"; query = 'sum(increase(nexusim_message_outbox_relay_errors_total[5m]))' },
        [pscustomobject]@{ name = "message_outbox_relay_consecutive_errors"; query = 'max(nexusim_message_outbox_relay_consecutive_errors)' },
        [pscustomobject]@{ name = "conversation_grpc_rps"; query = 'sum(rate(nexusim_conversation_grpc_method_requests_total[5m]))' },
        [pscustomobject]@{ name = "policy_grpc_rps"; query = 'sum(rate(nexusim_policy_grpc_method_requests_total[5m]))' },
        [pscustomobject]@{ name = "policy_grpc_check_avg_ms"; query = 'max(nexusim_policy_grpc_latency_avg_milliseconds{method="/nexusim.policy.v1.PolicyService/CheckMessageAction"})' },
        [pscustomobject]@{ name = "policy_grpc_check_max_ms"; query = 'max(nexusim_policy_grpc_latency_max_milliseconds{method="/nexusim.policy.v1.PolicyService/CheckMessageAction"})' },
        [pscustomobject]@{ name = "policy_decision_send_avg_ms"; query = 'max(nexusim_policy_decision_latency_avg_milliseconds{action="SEND"})' },
        [pscustomobject]@{ name = "policy_decision_send_max_ms"; query = 'max(nexusim_policy_decision_latency_max_milliseconds{action="SEND"})' },
        [pscustomobject]@{ name = "policy_decision_audit_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_outbox"})' },
        [pscustomobject]@{ name = "policy_decision_audit_max_ms"; query = 'max(nexusim_policy_decision_stage_latency_max_milliseconds{action="SEND",stage="decision_audit_outbox"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_max_ms"; query = 'max(nexusim_policy_decision_stage_latency_max_milliseconds{action="SEND",stage="decision_audit_kafka"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_build_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_build"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_marshal_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_marshal"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_publish_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_publish"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_errors_5m"; query = 'sum(increase(nexusim_policy_decision_stage_errors_total{action="SEND",stage=~"decision_audit_kafka|decision_audit_kafka_build|decision_audit_kafka_marshal|decision_audit_kafka_publish"}[5m]))' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_async_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_async"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_async_max_ms"; query = 'max(nexusim_policy_decision_stage_latency_max_milliseconds{action="SEND",stage="decision_audit_kafka_async"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_async_enqueue_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_async_enqueue"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_async_publish_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_async_publish"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_async_dlq_publish_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_kafka_async_dlq_publish"})' },
        [pscustomobject]@{ name = "policy_decision_audit_kafka_async_errors_5m"; query = 'sum(increase(nexusim_policy_decision_stage_errors_total{action="SEND",stage=~"decision_audit_kafka_async|decision_audit_kafka_async_build|decision_audit_kafka_async_marshal|decision_audit_kafka_async_enqueue|decision_audit_kafka_async_publish|decision_audit_kafka_async_retry|decision_audit_kafka_async_dlq_publish"}[5m]))' },
        [pscustomobject]@{ name = "policy_decision_audit_pool_acquire_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_pool_acquire"})' },
        [pscustomobject]@{ name = "policy_decision_audit_pool_acquire_max_ms"; query = 'max(nexusim_policy_decision_stage_latency_max_milliseconds{action="SEND",stage="decision_audit_pool_acquire"})' },
        [pscustomobject]@{ name = "policy_decision_audit_insert_exec_p99_ms"; query = 'max(nexusim_policy_decision_stage_latency_p99_milliseconds{action="SEND",stage="decision_audit_insert_exec"})' },
        [pscustomobject]@{ name = "policy_decision_audit_insert_exec_max_ms"; query = 'max(nexusim_policy_decision_stage_latency_max_milliseconds{action="SEND",stage="decision_audit_insert_exec"})' },
        [pscustomobject]@{ name = "policy_decision_audit_split_errors_5m"; query = 'sum(increase(nexusim_policy_decision_stage_errors_total{action="SEND",stage=~"decision_audit_pool_acquire|decision_audit_insert_exec"}[5m]))' },
        [pscustomobject]@{ name = "policy_evaluator_revision_lookup_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="policy_revision_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_facts_read_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="policy_facts_read"})' },
        [pscustomobject]@{ name = "policy_evaluator_decision_cache_get_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="decision_cache_get"})' },
        [pscustomobject]@{ name = "policy_evaluator_decision_cache_set_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="decision_cache_set"})' },
        [pscustomobject]@{ name = "policy_evaluator_contact_block_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="contact_block_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_user_restriction_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="user_restriction_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_role_gate_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="role_gate"})' },
        [pscustomobject]@{ name = "policy_evaluator_rebac_gate_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="rebac_gate"})' },
        [pscustomobject]@{ name = "policy_evaluator_tenant_quota_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="tenant_quota_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_message_action_rule_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="message_action_rule_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_exact_rule_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="exact_rule_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_tenant_rule_p99_ms"; query = 'max(nexusim_policy_evaluator_stage_latency_p99_milliseconds{action="SEND",stage="tenant_rule_lookup"})' },
        [pscustomobject]@{ name = "policy_evaluator_stage_errors_5m"; query = 'sum(increase(nexusim_policy_evaluator_stage_errors_total[5m]))' },
        [pscustomobject]@{ name = "policy_pg_pool_acquire_total"; query = 'max(nexusim_policy_pg_pool_acquire_total)' },
        [pscustomobject]@{ name = "policy_pg_pool_acquire_duration_ms_total"; query = 'max(nexusim_policy_pg_pool_acquire_duration_milliseconds_total)' },
        [pscustomobject]@{ name = "policy_pg_pool_empty_acquire_total"; query = 'max(nexusim_policy_pg_pool_empty_acquire_total)' },
        [pscustomobject]@{ name = "policy_pg_pool_canceled_acquire_total"; query = 'max(nexusim_policy_pg_pool_canceled_acquire_total)' },
        [pscustomobject]@{ name = "policy_pg_pool_conns_acquired"; query = 'max(nexusim_policy_pg_pool_conns{state="acquired"})' },
        [pscustomobject]@{ name = "policy_pg_pool_conns_max"; query = 'max(nexusim_policy_pg_pool_conns{state="max"})' },
        [pscustomobject]@{ name = "policy_audit_pg_pool_acquire_total"; query = 'max(nexusim_policy_audit_pg_pool_acquire_total)' },
        [pscustomobject]@{ name = "policy_audit_pg_pool_acquire_duration_ms_total"; query = 'max(nexusim_policy_audit_pg_pool_acquire_duration_milliseconds_total)' },
        [pscustomobject]@{ name = "policy_audit_pg_pool_empty_acquire_total"; query = 'max(nexusim_policy_audit_pg_pool_empty_acquire_total)' },
        [pscustomobject]@{ name = "policy_audit_pg_pool_canceled_acquire_total"; query = 'max(nexusim_policy_audit_pg_pool_canceled_acquire_total)' },
        [pscustomobject]@{ name = "policy_audit_pg_pool_conns_acquired"; query = 'max(nexusim_policy_audit_pg_pool_conns{state="acquired"})' },
        [pscustomobject]@{ name = "policy_audit_pg_pool_conns_max"; query = 'max(nexusim_policy_audit_pg_pool_conns{state="max"})' },
        [pscustomobject]@{ name = "policy_audit_outbox_pending"; query = 'max(nexusim_policy_audit_outbox{state="pending"})' },
        [pscustomobject]@{ name = "policy_audit_outbox_published"; query = 'max(nexusim_policy_audit_outbox{state="published"})' },
        [pscustomobject]@{ name = "policy_audit_outbox_dlq"; query = 'max(nexusim_policy_audit_outbox{state="dlq"})' },
        [pscustomobject]@{ name = "policy_outbox_relay_errors_5m"; query = 'sum(increase(nexusim_policy_outbox_relay_errors_total[5m]))' },
        [pscustomobject]@{ name = "policy_outbox_relay_consecutive_errors"; query = 'max(nexusim_policy_outbox_relay_consecutive_errors)' },
        ...
        [pscustomobject]@{ name = "delivery_timeline_worker_consecutive_errors"; query = 'max(nexusim_delivery_timeline_worker_consecutive_errors)' },
        [pscustomobject]@{ name = "delivery_timeline_worker_last_commit_age_seconds"; query = 'max(time() - (nexusim_delivery_timeline_worker_last_commit_unix_milliseconds / 1000))' },
        [pscustomobject]@{ name = "delivery_outbox_relay_errors_5m"; query = 'sum(increase(nexusim_delivery_outbox_relay_errors_total[5m]))' },
        [pscustomobject]@{ name = "delivery_outbox_relay_consecutive_errors"; query = 'max(nexusim_delivery_outbox_relay_consecutive_errors)' },
        [pscustomobject]@{ name = "delivery_outbox_relay_workers"; query = 'max(nexusim_delivery_outbox_relay_workers)' },
        [pscustomobject]@{ name = "delivery_outbox_relay_last_run_duration_ms"; query = 'max(nexusim_delivery_outbox_relay_last_run_duration_milliseconds)' },
        [pscustomobject]@{ name = "delivery_outbox_relay_last_publish_duration_ms"; query = 'max(nexusim_delivery_outbox_relay_last_publish_duration_milliseconds)' },
        [pscustomobject]@{ name = "delivery_outbox_relay_fetched_5m"; query = 'sum(increase(nexusim_delivery_outbox_relay_fetched_total[5m]))' },
        [pscustomobject]@{ name = "delivery_outbox_relay_published_5m"; query = 'sum(increase(nexusim_delivery_outbox_relay_published_total[5m]))' },
        ...
        [pscustomobject]@{ name = "message_outbox_process_ready_active_samples_window"; query = "sum(increase(nexusim_message_latency_samples_total{operation=`"outbox_process_ready_active`"}[$($WindowSeconds)s]))" },
        [pscustomobject]@{ name = "message_kafka_publish_call_samples_window"; query = "sum(increase(nexusim_message_latency_samples_total{operation=`"kafka_publish_call`"}[$($WindowSeconds)s]))" },
        [pscustomobject]@{ name = "message_outbox_relay_errors_window"; query = "sum(increase(nexusim_message_outbox_relay_errors_total[$($WindowSeconds)s]))" },
        [pscustomobject]@{ name = "policy_outbox_relay_errors_window"; query = "sum(increase(nexusim_policy_outbox_relay_errors_total[$($WindowSeconds)s]))" },
        [pscustomobject]@{ name = "delivery_outbox_relay_errors_window"; query = "sum(increase(nexusim_delivery_outbox_relay_errors_total[$($WindowSeconds)s]))" },
        [pscustomobject]@{ name = "delivery_outbox_relay_fetched_window"; query = "sum(increase(nexusim_delivery_outbox_relay_fetched_total[$($WindowSeconds)s]))" },
        [pscustomobject]@{ name = "delivery_outbox_relay_published_window"; query = "sum(increase(nexusim_delivery_outbox_relay_published_total[$($WindowSeconds)s]))" },
