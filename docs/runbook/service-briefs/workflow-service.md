...
## 后续
- 更多 compensation adapter、provider-grade batch approval / decision UI、callback delivery persisted dashboard / provider-grade batch redrive runner、workflow outbox relay。
