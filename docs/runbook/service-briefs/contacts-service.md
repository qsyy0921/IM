...
- 更细隐私策略：陌生人申请的正式审批 workflow、组织级策略和 admin/config service 权限面；当前 `risk_level / review_required` 是 first-stage 审计标注，不是完整审批状态机。
