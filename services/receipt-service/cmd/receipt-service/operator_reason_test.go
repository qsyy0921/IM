...
func TestReceiptOperatorReasonFromEnvDefault(t *testing.T) {
	...
	reason, err := receiptOperatorReasonFromEnv("NEXUSIM_RECEIPT_TEST_REASON", "NEXUSIM_RECEIPT_TEST_REASON_FILE", "manual fallback")
	if err != nil {
...
func TestReceiptOperatorReasonRejectsAmbiguousEnvAndFile(t *testing.T) {
	...
	t.Setenv("NEXUSIM_RECEIPT_TEST_REASON_FILE", reasonPath)
	if _, err := receiptOperatorReasonFromEnv("NEXUSIM_RECEIPT_TEST_REASON", "NEXUSIM_RECEIPT_TEST_REASON_FILE", "manual fallback"); err == nil {
