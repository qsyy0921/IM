...
| `identity-service` | WebAuthn/passkeys；外部 OIDC federation / OAuth client flows；多 issuer 治理；KMS/HSM；完整风控；生产级 email/SMS provider；租户级通知模板；bounce handling；已有本地 Login/Refresh 30m 长跑切片，仍需更完整容量曲线和生产 sizing。 |
