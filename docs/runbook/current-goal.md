...
- Latest fixture focus：multi-agent handoff、operator governance surface、operational readiness。
...
2. Eval / Replay、Runtime / Workflow、Context / Evidence、Memory、Tool、AgentOps、
   ...
   object completeness、operator governance surface 和 operational readiness
