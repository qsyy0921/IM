...
artifact readiness / install-plan contracts、desktop WebView metadata / login
dry-run contracts、Android metadata / login dry-run contracts、Android device /
WebView devtools readiness parsers、Android platform readiness 和 shell smoke plan
