...
var allowedPayloadKeys = map[string]bool{
	...
	"provider_failure_ref_hash": true,
	"source_execution_ref_hash": true,
	"source_result_ref_hash":    true,
	"replay_candidate_id":       true,
	"redrive_entrypoint":        true,
