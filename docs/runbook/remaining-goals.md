...
- `search-service`：AI 底座第一步，proto / migration / 六层 skeleton、PostgreSQL repository、真实 `SearchMessages` 查询、`grpc` runtime mode 和 timeline decoder / consumer 已落；下一步跑 projection smoke、visibility / tombstone 端到端验证，不做 LLM。
