...
- Workflow action boundary cases：provider replay queue、external approval binding、
  external callback wait、external callback delivery plan、delivery status / redrive
  plan、operator queues、compensation review bundle / page 和 compensation execution
  readiness。
