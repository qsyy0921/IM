...
- RAG EvidencePack coverage / projection、Agent prepare audit / tool policy
  metadata 已过 service-stack gate；profile / Agent safety fixture 已扩到 6 cases。
...
下一步：继续扩 service-stack RAG / Agent regression cases。
