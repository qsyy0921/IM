...
gate policy manifest, Python optional adapter path and RAG / Agent service-stack
live gate are landed. Next move is AI eval CI gate skeleton / more RAG-Agent
