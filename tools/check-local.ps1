...
try {
    ...
    Write-Host "== provider replay redrive result manifest =="
    Invoke-LocalCheck "check-provider-replay-redrive-result-manifest.ps1"

    Write-Host "== provider replay redrive audit append manifest =="
    Invoke-LocalCheck "check-provider-replay-redrive-audit-append-manifest.ps1"
    ...
    Write-Host "== workflow approval queue batch decision manifest =="
    Invoke-LocalCheck "check-workflow-approval-queue-batch-decision-manifest.ps1"
    ...
    Write-Host "== workflow approval queue decision audit append result manifest =="
    Invoke-LocalCheck "check-workflow-approval-queue-decision-audit-append-result-manifest.ps1"
    ...
    Write-Host "== workflow external callback batch redrive runner =="
    Invoke-LocalCheck "check-workflow-external-callback-batch-redrive-runner.ps1"

    Write-Host "== workflow external callback batch redrive audit append manifest =="
    Invoke-LocalCheck "check-workflow-external-callback-batch-redrive-audit-append-manifest.ps1"

    Write-Host "== workflow external callback batch redrive audit append result manifest =="
    Invoke-LocalCheck "check-workflow-external-callback-batch-redrive-audit-append-result-manifest.ps1"
    ...
    Write-Host "== workflow compensation execution invocation =="
    Invoke-LocalCheck "check-workflow-compensation-execution-invocation.ps1"
    ...
    Write-Host "== workflow compensation audit append result manifest =="
    Invoke-LocalCheck "check-workflow-compensation-execution-audit-append-result-manifest.ps1"
    ...
    Invoke-LocalCheck "check-capacity-longrun-campaign-summary.ps1"
    ...
    Write-Host "== api-gateway legacy evidence =="
    Invoke-LocalCheck "check-api-gateway-legacy-evidence.ps1"
