...
- gRPC TLS / mTLS 配置可以作为“服务端传输安全已开始落地”的面试点；SAN allowlist 已有第一版 exact-match 配置，但仍要说明没有完成全服务 mTLS、客户端迁移、证书轮换、动态服务身份注册或服务网格治理。
