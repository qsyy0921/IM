...
| 报告 | 说明 |
| --- | --- |
| `loadtest-report-20260616-api-gateway-stack-capacity-baseline.md` | 本地 api-gateway stack capacity baseline 覆盖 secure mTLS + HMAC GatewayService facade、push WebSocket、delivery / receipt / policy Kafka readback，原始结果在 H 盘 |
