...
2. ADR candidate package：`docs/research/adr-candidates/` 已起草六个候选 ADR
   ...
   Eval / Replay L2 scoped design 已起草；未过 owner review 前不提升生产契约。
3. Fixture-only evidence hardening：Eval / Replay、Runtime / Workflow、Context /
   ...
   六候选 L1 package 已闭环到 reviewability only；下一步优先 Eval / Replay L2
   review、Runtime / Workflow L2 design 或 owner-requested hardening。
