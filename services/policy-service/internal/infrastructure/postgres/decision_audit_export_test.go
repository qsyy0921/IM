...
func TestOutboxStoreExportDecisionAuditIntegration(t *testing.T) {
	...
	insertPolicyAuditOutboxRow(t, ctx, pool, "policy-audit-export-allowed", "tenant-policy:conversation-export-allowed", types.OutboxStatusPending, 0)
