...
$knownAssertionTypes = @(
    ...
    "must_create_provider_replay_operator_ui",
    "must_create_provider_replay_admin_handoff",
    "must_render_provider_replay_handoff_review_page",
    "must_not_execute_provider_replay_from_handoff_review",
    "must_render_provider_replay_execution_readiness_page",
    "must_bind_provider_replay_admin_workflow_and_fresh_proof",
    "must_not_execute_provider_replay_from_readiness_page",
    "must_create_provider_replay_redrive_invocation_manifest",
    "must_bind_redrive_invocation_to_fresh_proof",
    "must_not_execute_provider_replay_from_invocation_manifest",
    "must_preflight_provider_replay_redrive_execution",
    "must_verify_operator_supplied_redrive_inputs",
    "must_execute_provider_replay_only_via_action_executor_redrive",
    "must_keep_redrive_output_low_sensitive",
    "must_not_leak_raw_provider_replay_artifacts",
    "must_preflight_action_execution_audit_append",
    "must_append_external_audit_only_via_audit_service",
    "must_keep_audit_append_manifest_low_sensitive",
    "must_submit_provider_replay_admin_operation",
    "must_validate_provider_replay_payload_hash",
    "must_require_workflow_repair_approval",
    "must_list_provider_replay_workflow_queue",
    "must_expose_low_sensitive_workflow_queue",
    "must_list_workflow_operator_queues",
    "must_expose_low_sensitive_operator_queue_summary",
    "must_not_record_decision_from_operator_queue",
    "must_create_compensation_review_bundle",
    "must_render_compensation_review_page",
    "must_bind_compensation_instruction_to_workflow",
    "must_expose_low_sensitive_compensation_review",
    "must_not_execute_compensation_from_review",
    "must_not_leak_raw_compensation_artifacts",
    "must_create_compensation_execution_readiness",
    "must_bind_compensation_execution_to_review_bundle",
    "must_keep_compensation_execution_readiness_low_sensitive",
    "must_not_execute_compensation_from_readiness",
    "must_keep_redrive_entrypoint_action_executor",
    "must_not_execute_provider_replay_on_submit",
    "must_not_execute_provider_replay_from_workflow_queue",
    "must_bind_external_decision_to_workflow_payload",
    "must_reject_external_decision_binding_mismatch",
    "must_not_record_decision_before_binding_check",
    "must_create_external_callback_wait_workflow",
    "must_emit_external_decision_manifest_template",
    "must_not_record_decision_before_external_callback",
    "must_create_external_callback_delivery_plan",
    "must_bind_callback_delivery_to_waiting_workflow",
    "must_keep_callback_delivery_low_sensitive",
    "must_not_record_decision_from_callback_delivery",
    "must_not_execute_target_from_callback_delivery",
    "must_require_callback_retry_policy",
    "must_create_external_callback_delivery_status",
    "must_bind_callback_status_to_delivery_plan",
    "must_keep_callback_status_low_sensitive",
    "must_create_external_callback_redrive_plan",
    "must_not_call_provider_from_callback_status_or_redrive",
    "must_not_record_decision_from_callback_status_or_redrive",
    "must_not_execute_target_from_callback_status_or_redrive",
    "must_transition_waiting_workflow_to_timed_out",
    "must_emit_low_sensitive_workflow_timeout_event",
    "must_not_create_implicit_approval_on_timeout",
    "must_require_fresh_replay_approval",
    "must_preserve_replay_audit_boundary",
