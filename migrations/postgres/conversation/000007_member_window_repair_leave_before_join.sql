...
ALTER TABLE conversation_member_window_repair_audit
    ...
    CHECK (issue_class IN ('ACTIVE_WITH_LEAVE_SEQ', 'INACTIVE_WITHOUT_LEAVE_SEQ', 'LEAVE_BEFORE_JOIN')) NOT VALID;
...
ALTER TABLE conversation_member_window_repair_audit
    ...
    CHECK (repair_action IN ('clear_active_leave_seq', 'set_inactive_leave_seq', 'clamp_leave_to_join_seq')) NOT VALID;
