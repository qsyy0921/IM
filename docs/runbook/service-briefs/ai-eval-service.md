...
- RAG / Agent live gate 已扩到 19 cases；Summary live adapter 已覆盖 grounded
  citation 和 no-evidence abstain；profile fixture 6 cases。
...
下一步：补 Python / model-output negative regression cases。
