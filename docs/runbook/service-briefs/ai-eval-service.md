...
- RAG / Agent live gate 已扩到 19 cases：version / prepare audit / tool policy
  / hash-only / RAG no-evidence / Agent policy-denied；profile fixture 6 cases。
...
下一步：补 Summary / Python / model-output negative regression cases。
