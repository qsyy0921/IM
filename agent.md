...
live gate, CI-safe gate skeleton and first RAG-Agent regression expansion are landed.
Next move is deeper service-stack RAG-Agent regression cases, or `current-goal.md`.
