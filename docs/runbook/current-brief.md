...
Eval / Replay、Runtime / Workflow、Context / Evidence、Memory、Tool、AgentOps
fixture evidence 已落地；dataset reproducibility evidence 已补齐。若继续编码，
优先主集成 review 指出的 P0/P1 或 focused contract/version hardening。
完整模块完成后 commit、push
