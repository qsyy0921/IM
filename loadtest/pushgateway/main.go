...
func parseConfig() config {
	...
	flag.StringVar(&cfg.scenario, "scenario", "full", "scenario: full, message-change-notify, resume-replay, cross-instance-resume, slow-client, redis-fault, redis-sentinel-failover, redis-sentinel-master-stop, redis-sentinel-quorum-loss, redis-sentinel-network-partition, or identity-revoke")
