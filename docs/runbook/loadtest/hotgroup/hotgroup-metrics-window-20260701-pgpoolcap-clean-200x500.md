...
- run_name: hotgroup-pgpoolcap-clean-200x500-64c-d4e211d8-20260701-1520
- commit: d4e211d
- git_dirty: False
...
- window_start_utc: 2026-07-01T07:17:43.4187692Z
- window_end_utc: 2026-07-01T07:28:21.6633588Z
- step_seconds: 30
...
| message_send_p95_ms | True | 1 | 22 | 667.718 | 742.904 | 667.718 | max(nexusim_message_latency_p95_milliseconds{operation="send_message"}) |
| message_send_p99_ms | True | 1 | 22 | 916.459 | 1023.237 | 916.459 | max(nexusim_message_latency_p99_milliseconds{operation="send_message"}) |
| message_seq_alloc_p99_ms | True | 1 | 22 | 810.346 | 926.045 | 810.346 | max(nexusim_message_latency_p99_milliseconds{operation="conversation_seq_alloc"}) |
...
| conversation_grpc_rps | True | 1 | 22 | 0 | 2.626 | 0 | sum(rate(nexusim_conversation_grpc_method_requests_total[5m])) |
| delivery_outbox_pending | True | 1 | 22 | 0 | 1600 | 0 | max(nexusim_delivery_outbox{state="pending"}) |
| delivery_outbox_pending_ready | True | 1 | 22 | 0 | 1600 | 0 | max(nexusim_delivery_outbox{state="pending_ready"}) |
| delivery_outbox_dlq | True | 1 | 22 | 0 | 0 | 0 | max(nexusim_delivery_outbox{state="dlq"}) |
| delivery_projection_unresolved | True | 1 | 22 | 0 | 0 | 0 | max(nexusim_delivery_projection_failures{state="unresolved_total"}) |
...
| delivery_grpc_rps | True | 1 | 21 | 0 | 0.098 | 0.098 | sum(rate(nexusim_delivery_grpc_method_requests_total[5m])) |
| delivery_grpc_errors_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_delivery_grpc_method_errors_total[5m])) |
...
| push_consumer_worker_errors_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_consumer_worker_errors_total[5m])) |
| push_redis_route_events_5m | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total[5m])) |
...
| push_redis_delivery_consumer_remote_matched_sessions_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_matched_sessions"}[5m])) |
| push_redis_delivery_consumer_remote_publish_call_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_call"}[5m])) |
| push_redis_delivery_consumer_remote_publish_error_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_error"}[5m])) |
| push_redis_delivery_consumer_remote_no_subscriber_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_no_subscriber"}[5m])) |
| push_redis_delivery_consumer_conversation_route_cache_hit_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_hit"}[5m])) |
| push_redis_delivery_consumer_conversation_route_cache_miss_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_miss"}[5m])) |
| push_redis_delivery_consumer_conversation_route_cache_invalidated_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_invalidated"}[5m])) |
| push_redis_delivery_consumer_remote_enqueued_sessions_5m | True | 1 | 21 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_enqueued_sessions"}[5m])) |
...
| push_writer_frame_write_success_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="frame_write_success"}[638s])) |
| push_writer_frame_write_error_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="frame_write_error"}[638s])) |
| push_writer_delivery_notify_success_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="delivery_notify_write_success"}[638s])) |
| push_writer_delivery_notify_error_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="delivery_notify_write_error"}[638s])) |
| push_writer_delivery_notify_duration_p95_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_ws_writer_write_duration_milliseconds_bucket{operation="delivery_notify"}[638s])) by (le)) |
| push_writer_delivery_notify_duration_p99_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_ws_writer_write_duration_milliseconds_bucket{operation="delivery_notify"}[638s])) by (le)) |
| push_writer_delivery_notify_queue_p95_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_ws_writer_queue_duration_milliseconds_bucket{operation="delivery_notify"}[638s])) by (le)) |
| push_writer_delivery_notify_queue_p99_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_ws_writer_queue_duration_milliseconds_bucket{operation="delivery_notify"}[638s])) by (le)) |
| push_redis_subscriber_messages_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_message"}[638s])) |
| push_redis_subscriber_enqueued_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_enqueued"}[638s])) |
| push_redis_subscriber_evicted_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_evicted"}[638s])) |
| push_redis_subscriber_errors_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_error"}[638s])) |
| push_redis_registry_conversation_route_cache_hit_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_hit"}[638s])) |
| push_redis_registry_conversation_route_cache_miss_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_miss"}[638s])) |
| push_redis_registry_conversation_route_cache_invalidated_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_invalidated"}[638s])) |
| push_redis_delivery_consumer_remote_matched_sessions_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_matched_sessions"}[638s])) |
| push_redis_delivery_consumer_remote_publish_call_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_call"}[638s])) |
| push_redis_delivery_consumer_remote_publish_error_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_error"}[638s])) |
| push_redis_delivery_consumer_conversation_route_cache_hit_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_hit"}[638s])) |
| push_redis_delivery_consumer_conversation_route_cache_miss_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_miss"}[638s])) |
| push_redis_delivery_consumer_conversation_route_cache_invalidated_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_invalidated"}[638s])) |
| push_redis_delivery_consumer_remote_enqueued_sessions_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_enqueued_sessions"}[638s])) |
| push_redis_subscriber_signal_fanout_queued_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_queued"}[638s])) |
| push_redis_subscriber_signal_fanout_queue_full_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_queue_full"}[638s])) |
| push_redis_subscriber_signal_fanout_worker_errors_window | True | 1 | 22 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_worker_error"}[638s])) |
| push_redis_subscriber_signal_fanout_duration_p95_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_redis_subscriber_fanout_duration_milliseconds_bucket{operation="conversation_signal"}[638s])) by (le)) |
| push_redis_subscriber_signal_fanout_duration_p99_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_redis_subscriber_fanout_duration_milliseconds_bucket{operation="conversation_signal"}[638s])) by (le)) |
| push_redis_subscriber_signal_fanout_queue_wait_p95_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_redis_subscriber_signal_fanout_queue_wait_duration_milliseconds_bucket[638s])) by (le)) |
| push_redis_subscriber_signal_fanout_queue_wait_p99_ms_window | True | 1 | 22 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_redis_subscriber_signal_fanout_queue_wait_duration_milliseconds_bucket[638s])) by (le)) |
