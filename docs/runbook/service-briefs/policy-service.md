...
- 完整 ReBAC、provider-grade moderation / risk scoring、tenant DSL / quota、外部 audit sink；当前 keyword / HTTP moderation、Prometheus / Grafana 和 direct capacity baseline 只用于本地开发和面试展示，生产 OTel collector / alerting / SLO dashboard、长时间容量曲线和生产 sizing 仍属于后续统一观测治理。
