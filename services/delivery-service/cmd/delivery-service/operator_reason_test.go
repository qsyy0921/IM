...
func TestDeliveryOperatorReasonFromEnvDefault(t *testing.T) {
	...
	reason, err := deliveryOperatorReasonFromEnv("NEXUSIM_DELIVERY_TEST_REASON", "NEXUSIM_DELIVERY_TEST_REASON_FILE", "manual fallback")
	if err != nil {
...
func TestDeliveryOperatorReasonRejectsAmbiguousEnvAndFile(t *testing.T) {
	...
	t.Setenv("NEXUSIM_DELIVERY_TEST_REASON_FILE", reasonPath)
	if _, err := deliveryOperatorReasonFromEnv("NEXUSIM_DELIVERY_TEST_REASON", "NEXUSIM_DELIVERY_TEST_REASON_FILE", "manual fallback"); err == nil {
