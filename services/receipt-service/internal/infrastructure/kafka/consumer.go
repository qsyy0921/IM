...
func (consumer *ReaderConsumer) Fetch(ctx context.Context) (types.DeliveryMessage, error) {
	if consumer == nil || consumer.reader == nil {
		return types.DeliveryMessage{}, errors.New("kafka reader consumer is not configured")
	}
	message, err := consumer.reader.FetchMessage(ctx)
	if err != nil {
		return types.DeliveryMessage{}, err
	}
...
func (consumer *ReaderConsumer) Commit(ctx context.Context, message types.DeliveryMessage) error {
	if consumer == nil || consumer.reader == nil {
