...
2. Eval / Replay 和 Runtime / Workflow fixture evidence 已落地；若继续编码，
   优先 Context denied-lane retention、Memory revocation/category threshold、
   Tool prepare-expiry 或 AgentOps release-blocking 证据。
