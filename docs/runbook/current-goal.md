...
- Latest fixture focus：operational readiness、controlled implementation readiness、architecture coverage。
...
2. Eval / Replay、Runtime / Workflow、Context / Evidence、Memory、Tool、AgentOps、
   ...
   object completeness、operator governance、operational readiness、controlled implementation readiness 和 architecture coverage
