...
- `workflow-service` product-active：SDD v0.1 和 stage-switch review 已通过，
  ...
  record-decision / workflow-list / provider-replay-queue / instruction-list operator CLI；
  ...
  platform、provider-grade instruction UI、external callback wait 或 outbox relay。
