...
- run_name: hotgroup-seqfloorcache-readfanout-6000x1000-256c-f34e571d-20260701-1625
- commit: f34e571
- git_dirty: True
...
- window_start_utc: 2026-07-01T08:05:30.4284514Z
- window_end_utc: 2026-07-01T08:16:45.0359519Z
- step_seconds: 30
...
| message_send_p95_ms | True | 1 | 23 | 0 | 1006.376 | 1006.376 | max(nexusim_message_latency_p95_milliseconds{operation="send_message"}) |
| message_send_p99_ms | True | 1 | 23 | 0 | 1242.377 | 1242.377 | max(nexusim_message_latency_p99_milliseconds{operation="send_message"}) |
| message_seq_alloc_p99_ms | True | 1 | 23 | 0 | 830.92 | 789.095 | max(nexusim_message_latency_p99_milliseconds{operation="conversation_seq_alloc"}) |
| message_repository_append_p99_ms | True | 1 | 23 | 0 | 1212.968 | 1212.968 | max(nexusim_message_latency_p99_milliseconds{operation="repository_append"}) |
| message_repository_pool_acquire_p99_ms | True | 1 | 23 | 0 | 695.913 | 695.913 | max(nexusim_message_latency_p99_milliseconds{operation="repository_pool_acquire"}) |
| message_repository_tx_begin_p99_ms | True | 1 | 23 | 0 | 3.234 | 1.031 | max(nexusim_message_latency_p99_milliseconds{operation="repository_tx_begin"}) |
| message_repository_idempotency_lock_p99_ms | True | 1 | 23 | 0 | 7.212 | 5.205 | max(nexusim_message_latency_p99_milliseconds{operation="repository_idempotency_lock"}) |
| message_repository_find_existing_p99_ms | True | 1 | 23 | 0 | 23.527 | 14.812 | max(nexusim_message_latency_p99_milliseconds{operation="repository_find_existing"}) |
| message_repository_ensure_seq_p99_ms | True | 1 | 23 | 0 | 378.984 | 310.869 | max(nexusim_message_latency_p99_milliseconds{operation="repository_ensure_seq"}) |
| message_repository_allocate_seq_p99_ms | True | 1 | 23 | 0 | 808.362 | 714.239 | max(nexusim_message_latency_p99_milliseconds{operation="repository_allocate_seq"}) |
| message_repository_insert_message_p99_ms | True | 1 | 23 | 0 | 2.307 | 1.661 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_message"}) |
| message_repository_insert_timeline_p99_ms | True | 1 | 23 | 0 | 2.856 | 2.507 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_timeline"}) |
| message_repository_insert_outbox_p99_ms | True | 1 | 23 | 0 | 5.04 | 4.429 | max(nexusim_message_latency_p99_milliseconds{operation="repository_insert_outbox"}) |
| message_repository_commit_p99_ms | True | 1 | 23 | 0 | 3.313 | 2.982 | max(nexusim_message_latency_p99_milliseconds{operation="repository_commit"}) |
...
| conversation_grpc_rps | True | 1 | 23 | 0 | 25.926 | 0 | sum(rate(nexusim_conversation_grpc_method_requests_total[5m])) |
| delivery_outbox_pending | True | 1 | 3 | 0 | 0 | 0 | max(nexusim_delivery_outbox{state="pending"}) |
| delivery_outbox_pending_ready | True | 1 | 3 | 0 | 0 | 0 | max(nexusim_delivery_outbox{state="pending_ready"}) |
| delivery_outbox_dlq | True | 1 | 3 | 0 | 0 | 0 | max(nexusim_delivery_outbox{state="dlq"}) |
| delivery_projection_unresolved | True | 1 | 3 | 0 | 0 | 0 | max(nexusim_delivery_projection_failures{state="unresolved_total"}) |
...
| delivery_grpc_rps | True | 1 | 23 | 0 | 0.126 | 0 | sum(rate(nexusim_delivery_grpc_method_requests_total[5m])) |
...
| push_redis_route_events_5m | True | 1 | 23 | 0 | 2063.934 | 356.614 | sum(increase(nexusim_push_gateway_redis_route_events_total[5m])) |
...
| push_redis_delivery_consumer_conversation_route_cache_hit_5m | True | 1 | 23 | 0 | 984.171 | 170.602 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_hit"}[5m])) |
| push_redis_delivery_consumer_conversation_route_cache_miss_5m | True | 1 | 23 | 0 | 102.11 | 17.611 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_miss"}[5m])) |
...
| push_writer_frame_write_success_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="frame_write_success"}[675s])) |
...
| push_writer_delivery_notify_success_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_ws_writer_events_total{event="delivery_notify_write_success"}[675s])) |
...
| push_writer_delivery_notify_duration_p95_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_ws_writer_write_duration_milliseconds_bucket{operation="delivery_notify"}[675s])) by (le)) |
| push_writer_delivery_notify_duration_p99_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_ws_writer_write_duration_milliseconds_bucket{operation="delivery_notify"}[675s])) by (le)) |
| push_writer_delivery_notify_queue_p95_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_ws_writer_queue_duration_milliseconds_bucket{operation="delivery_notify"}[675s])) by (le)) |
| push_writer_delivery_notify_queue_p99_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_ws_writer_queue_duration_milliseconds_bucket{operation="delivery_notify"}[675s])) by (le)) |
| push_redis_subscriber_messages_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_message"}[675s])) |
| push_redis_subscriber_enqueued_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_enqueued"}[675s])) |
...
| push_redis_registry_conversation_route_cache_hit_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_hit"}[675s])) |
| push_redis_registry_conversation_route_cache_miss_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_miss"}[675s])) |
| push_redis_registry_conversation_route_cache_invalidated_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="registry",event="conversation_route_cache_invalidated"}[675s])) |
| push_redis_delivery_consumer_remote_matched_sessions_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_matched_sessions"}[675s])) |
| push_redis_delivery_consumer_remote_publish_call_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_call"}[675s])) |
| push_redis_delivery_consumer_remote_publish_error_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_publish_error"}[675s])) |
| push_redis_delivery_consumer_conversation_route_cache_hit_window | True | 1 | 23 | 0 | 935.578 | 935.578 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_hit"}[675s])) |
| push_redis_delivery_consumer_conversation_route_cache_miss_window | True | 1 | 23 | 0 | 97.069 | 97.069 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_miss"}[675s])) |
| push_redis_delivery_consumer_conversation_route_cache_invalidated_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="conversation_route_cache_invalidated"}[675s])) |
| push_redis_delivery_consumer_remote_enqueued_sessions_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="delivery-consumer",event="remote_enqueued_sessions"}[675s])) |
| push_redis_subscriber_signal_fanout_queued_window | True | 1 | 23 | 0 | 0 | 0 | sum(increase(nexusim_push_gateway_redis_route_events_total{role="subscriber",event="subscriber_signal_fanout_queued"}[675s])) |
...
| push_redis_subscriber_signal_fanout_duration_p95_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_redis_subscriber_fanout_duration_milliseconds_bucket{operation="conversation_signal"}[675s])) by (le)) |
| push_redis_subscriber_signal_fanout_duration_p99_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_redis_subscriber_fanout_duration_milliseconds_bucket{operation="conversation_signal"}[675s])) by (le)) |
| push_redis_subscriber_signal_fanout_queue_wait_p95_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.95, sum(increase(nexusim_push_gateway_redis_subscriber_signal_fanout_queue_wait_duration_milliseconds_bucket[675s])) by (le)) |
| push_redis_subscriber_signal_fanout_queue_wait_p99_ms_window | True | 1 | 23 | NaN | NaN | NaN | histogram_quantile(0.99, sum(increase(nexusim_push_gateway_redis_subscriber_signal_fanout_queue_wait_duration_milliseconds_bucket[675s])) by (le)) |
| message_pg_pool_conns | True | 1 | 23 | 64 | 64 | 64 | max(nexusim_message_pg_pool_conns) |
