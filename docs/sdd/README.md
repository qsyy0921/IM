...
- 当前 AI 底座路线只把 `search-service.md` 作为第一步 SDD；后续新增 `memory-service`、`retrieval-gateway`、RAG、summary、Agent、skill / MCP / action 服务时再补对应 SDD，不从旧文档推断目标。
...
- `api-gateway.md`
- `search-service.md`
- 后续待新增：`memory-service.md`、`retrieval-gateway.md`、`rag-service.md`、`summary-service.md`、`agent-service.md`、`skill-registry.md`、`mcp-gateway.md`、`action-executor.md`。
