...
- RAG / Agent live gate 19 cases；Summary live 2 cases；profile fixture 6 cases；Python worker 5 cases；RAG/Summary citation、external MCP fallback、Agent output regression 和 action preflight / rate-limit safety eval 已落。
...
下一步：继续补 action-executor DLQ / repair safety cases。
