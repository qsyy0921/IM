...
version / hash-only, negative cases, Summary live negative adapter and Python
model-output negatives are landed. Next: external MCP fallback, tool/action safety and RAG/summary citation regression.
