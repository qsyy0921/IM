...
| `admin-service` | 租户管理、封禁、配置、运维操作、repair 工作台；第一版已把 repair 和 CRITICAL 管理操作接入 workflow 长审批，提供公开 gRPC operator CLI 做审批 / 查询，并打通非 critical `CONFIG_PUBLISH -> control-plane-service` 第一条真实下游 adapter |
