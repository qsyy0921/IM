...
2. Eval / Replay、Runtime / Workflow、Context / Evidence fixture evidence 已落地；
   若继续编码，优先 Memory revocation/category threshold、Tool prepare-expiry
   或 AgentOps release-blocking 证据。
