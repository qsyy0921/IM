...
func (c *policyServiceClient) CheckMessageAction(ctx context.Context, in *CheckMessageActionRequest, opts ...grpc.CallOption) (*CheckMessageActionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckMessageActionResponse)
	err := c.cc.Invoke(ctx, PolicyService_CheckMessageAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PolicyService_CheckMessageAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckMessageActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyServiceServer).CheckMessageAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyService_CheckMessageAction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).CheckMessageAction(ctx, req.(*CheckMessageActionRequest))
	}
...
var PolicyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nexusim.policy.v1.PolicyService",
	...
	Metadata: "nexusim/policy/v1/policy_service.proto",
}
