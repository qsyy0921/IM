...
- PostgreSQL repository 已按主流程 / helper / privacy / privacy exception / source policy 同 package 拆分，避免联系人逻辑继续堆进单个大文件；PostgreSQL privacy / source-policy / contact-edge 集成测试也已拆到独立同 package 测试文件。
