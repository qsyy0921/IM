...
2. ADR candidate package：`docs/research/adr-candidates/` 已起草六个候选 ADR
   ...
   Eval / Replay、Runtime / Workflow 和 Context / EvidencePack L2 已被主集成接受为 review material；Memory Admission L2 已起草。
3. Fixture-only evidence hardening：Eval / Replay、Runtime / Workflow、Context /
   ...
   六候选 L1 package 已闭环到 reviewability only；下一步优先四份 L2 owner
