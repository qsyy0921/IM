...
- `media-service` product-active：SDD v0.1 和 stage-switch review 已通过，第一版
  ...
  public response / fake presign URL / outbox payload 的回归门禁已补；下一步补
  最小 gRPC smoke。
