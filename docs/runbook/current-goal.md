...
- Latest fixture focus：operator governance、operational readiness、controlled implementation readiness。
...
2. Eval / Replay、Runtime / Workflow、Context / Evidence、Memory、Tool、AgentOps、
   ...
   object completeness、operator governance、operational readiness 和 controlled implementation readiness
