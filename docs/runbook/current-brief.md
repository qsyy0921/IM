...
- Full-package entry 已被主集成接受进入 ADR review；Eval / Replay L1 自评包已起草，
  但 actual implementation 仍被 accepted ADR / owner / smoke 阻断。
...
若继续架构推进，优先等待或支撑主集成 Eval / Replay L1 ADR review。
