...
- RAG / Agent live gate 19 cases；Summary live 2 cases；profile fixture 6 cases；Python worker 5 cases；RAG/Summary citation、external MCP fallback 和 Agent output regression 已落。
...
下一步：继续补 tool/action safety cases。
