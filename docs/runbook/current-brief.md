...
4. api-gateway 已补 first-stage tenant-scoped rate limit 和静态 tenant plan override；下一步继续治理 api-gateway：legacy descriptor 显式 opt-in、OpenTelemetry trace 和运行时动态 quota 配置。
