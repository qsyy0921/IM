...
| `agent-plane-initial-design.md` | Agent Exploration Mode 的初步设计报告，综合当前开源项目、论文、benchmark 和产品技术报告输入，不冻结契约。详细 SDD 包见 `../sdd/agent-platform.md`、`../sdd/agent-runtime.md`、`../sdd/agent-memory-admission.md`、`../sdd/agent-context-evidencepack.md`、`../sdd/agent-tool-mcp-boundary.md`、`../sdd/agent-eval-replay-harness.md` 和 `../sdd/agent-governance-agentops.md`。 |
...
6. 需要当前 Agent 层重新设计草案时，先读 `agent-plane-initial-design.md` 和
   `../sdd/agent-platform.md`；进入实现前必须再读 `../research/agent-current-design-review-20260701.md`
   以及 runtime、memory admission、context、tool/MCP、eval/replay、governance 的详细 SDD。
