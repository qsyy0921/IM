...
- Full-package entry review request 和 ADR acceptance review playbook 已发起：
  只请求 ADR acceptance review；actual implementation 仍被 ADR / owner / smoke 阻断。
...
若继续架构推进，等待主集成完整包准入评审或按 playbook 处理 P0/P1 打回。
